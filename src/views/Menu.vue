...
export default {
  ...
  data() {
    return {
      ...
      menuOptions: [
        {
          title: "推荐",
          inactiveIcon: require("../assets/images/recommend.png"),
          activeIcon: require("../assets/images/recommend_active.png"),
        },
        {
          title: "拿铁",
          inactiveIcon: require("../assets/images/latte.png"),
          activeIcon: require("../assets/images/latte_active.png"),
        },
        {
          title: "咖啡",
          inactiveIcon: require("../assets/images/coffee.png"),
          activeIcon: require("../assets/images/coffee_active.png"),
        },
        {
          title: "瑞纳冰",
          inactiveIcon: require("../assets/images/reina.png"),
          activeIcon: require("../assets/images/reina_active.png"),
        },
      ],
  ...
  created() {
    ...
    if(sessionStorage.getItem("indexId")){
      this.menuIndex = sessionStorage.getItem("indexId");
    }
  },
  ...
  methods: {
    ...
    toggleMenu(index, type) {
      ...
      // 缓存下标
      sessionStorage.setItem("indexId",index);

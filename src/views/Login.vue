    ...
    >
      <template #left>
        <div class="nav-left">
          ...
          <div class="logo-text">Funny Coffee</div>
        </div>
      </template>
    </van-nav-bar>
    ...
    <div class="user-box">
      ...
      <van-form>
        ...
        <div class="commit-btn">
          <van-button round block color="#ffa500" @click="login">
            登录
          </van-button>
        </div>
        <div class="commit-btn">
          <van-button round block color="#ffca67" type="default" @click="toggleRegisterBox">
            注册
          </van-button>
        </div>
      </van-form>
    ...
    <van-popup class="register-box" v-model="isShow" position="bottom" closeable>
       ...
       <van-form>
        ...
        <div class="commit-btn register-btn">
          <van-button round block color="#ffa500" @click="register">
            注册
          </van-button>
        </div>
      </van-form>
